  ...
  return (
    <div className="flex justify-center items-center min-h-screen ">
      <div className="bg-gray-900 rounded-lg shadow-md w-full max-w-lg">
        <h1 className="text-2xl font-semibold text-center mb-4 text-white">Private Chat Room</h1>
        ...
        <form onSubmit={handleClick}>
          ...
          <h5 className="text-1xl font-semibold text-center mb-2 text-white">
            Don't have an account? <NavLink to="/" className=" text-blue  hover:text-blue-600"> Sign up</NavLink>
          </h5>
          <button
            type="submit"
